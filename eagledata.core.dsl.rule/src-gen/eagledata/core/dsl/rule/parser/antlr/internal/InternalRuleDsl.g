...
@after {
	...
	(
		(
			(
				{
					newCompositeNode(grammarAccess.getRuleModelAccess().getImportSectionXImportSectionParserRuleCall_0_0());
				}
	...
	(
		...
		(
			(
				...
				{
					newCompositeNode(grammarAccess.getRuleAccess().getEventPhraseCrossReference_3_0());
				}
				ruleValidID
				{
					afterParserOrEnumRuleCall();
		...
		(
			(
				(
					...
					{
						newCompositeNode(grammarAccess.getAddingSelectAccess().getElementFeatureCrossReference_1_0_0());
					}
					ruleValidID
					{
						afterParserOrEnumRuleCall();
			...
			(
				...
				(
					(
						...
						{
							newCompositeNode(grammarAccess.getWhereAccess().getRightStreamingFeatureCrossReference_2_1_1_0());
						}
						ruleValidID
						{
							afterParserOrEnumRuleCall();
