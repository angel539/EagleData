...
public class AddingSelectImpl extends SelectImpl implements AddingSelect
{
  ...
  public Feature getElement()
  {
    if (element != null && element.eIsProxy())
    {
      ...
      element = (Feature)eResolveProxy(oldElement);
   ...
   * @generated
   */
  public Feature basicGetElement()
  {
    return element;
  }
   ...
   * @generated
   */
  public void setElement(Feature newElement)
  {
    Feature oldElement = element;
    element = newElement;
    if (eNotificationRequired())
