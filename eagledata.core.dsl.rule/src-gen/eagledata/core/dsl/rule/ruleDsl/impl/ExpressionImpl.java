 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.rule.ruleDsl.impl.ExpressionImpl#getPlainOperand <em>Plain Operand</em>}</li>
 *   <li>{@link eagledata.core.dsl.rule.ruleDsl.impl.ExpressionImpl#getComplexOperands <em>Complex Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression
{
  ...
  {
    return RuleDslPackage.Literals.EXPRESSION;
  }
  ...
  public NotificationChain basicSetPlainOperand(PlainOperand newPlainOperand, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RuleDslPackage.EXPRESSION__PLAIN_OPERAND, oldPlainOperand, newPlainOperand);
  ...
  public void setPlainOperand(PlainOperand newPlainOperand)
  {
    if (newPlainOperand != plainOperand)
    {
      ...
      if (plainOperand != null)
        msgs = ((InternalEObject)plainOperand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RuleDslPackage.EXPRESSION__PLAIN_OPERAND, null, msgs);
      if (newPlainOperand != null)
        msgs = ((InternalEObject)newPlainOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RuleDslPackage.EXPRESSION__PLAIN_OPERAND, null, msgs);
      msgs = basicSetPlainOperand(newPlainOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RuleDslPackage.EXPRESSION__PLAIN_OPERAND, newPlainOperand, newPlainOperand));
  }
  ...
  public EList<ComplexOperand> getComplexOperands()
  {
    ...
    {
      complexOperands = new EObjectContainmentEList<ComplexOperand>(ComplexOperand.class, this, RuleDslPackage.EXPRESSION__COMPLEX_OPERANDS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RuleDslPackage.EXPRESSION__PLAIN_OPERAND:
        return basicSetPlainOperand(null, msgs);
      case RuleDslPackage.EXPRESSION__COMPLEX_OPERANDS:
