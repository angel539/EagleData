 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadesc.dataDsl.impl.DataDescriptionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataDescriptionImpl extends MinimalEObjectImpl.Container implements DataDescription
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDslPackage.DATA_DESCRIPTION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DataDslPackage.DATA_DESCRIPTION__NAME:
        return getName();
    }
