...
import eagledata.core.dsl.datadesc.web.DataDslWebSetup;
...
public class DataDslServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      DataDslWebSetup _dataDslWebSetup = new DataDslWebSetup(executorServiceProvider);
      _dataDslWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
