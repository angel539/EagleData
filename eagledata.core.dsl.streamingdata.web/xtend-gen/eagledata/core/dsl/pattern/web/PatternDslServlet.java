...
import eagledata.core.dsl.pattern.web.PatternDslWebSetup;
...
public class PatternDslServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      PatternDslWebSetup _patternDslWebSetup = new PatternDslWebSetup(executorServiceProvider);
      _patternDslWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
