...
/**
 * Manual modifications go to {@link SemanticNodesDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractSemanticNodesDslUiModule extends DefaultXbaseUiModule {

	public AbstractSemanticNodesDslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(uam.eagledata.dsl.semanticnodes.parser.antlr.internal.InternalSemanticNodesDslLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalSemanticNodesDslLexer.class).toProvider(LexerProvider.create(InternalSemanticNodesDslLexer.class));
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialSemanticNodesDslContentAssistParser.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return SemanticNodesDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return SemanticNodesDslProposalProvider.class;
	}
