...
public class InternalRuleDslLexer extends Lexer {
    ...
    public final void mT__20() throws RecognitionException {
        try {
            int _type = T__20;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:15:7: ( 'do' )
            // InternalRuleDsl.g:15:9: 'do'
            {
            match("do"); 
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:24:7: ( 'when' )
            // InternalRuleDsl.g:24:9: 'when'
            {
            match("when"); 
    ...
    public final void mRULE_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2878:15: ( ( '+' | '-' | '*' | 'DIV' ) )
            // InternalRuleDsl.g:2878:17: ( '+' | '-' | '*' | 'DIV' )
            {
            // InternalRuleDsl.g:2878:17: ( '+' | '-' | '*' | 'DIV' )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_LOGICALOPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2880:22: ( ( '>' | '<' | '>=' | '<=' | '=' ) )
            // InternalRuleDsl.g:2880:24: ( '>' | '<' | '>=' | '<=' | '=' )
            {
            // InternalRuleDsl.g:2880:24: ( '>' | '<' | '>=' | '<=' | '=' )
            int alt2=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_SELECTOPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2882:21: ( ( 'COUNT' | 'MIN' | 'MAX' ) )
            // InternalRuleDsl.g:2882:23: ( 'COUNT' | 'MIN' | 'MAX' )
            {
            // InternalRuleDsl.g:2882:23: ( 'COUNT' | 'MIN' | 'MAX' )
            int alt3=3;
            ...
            switch (alt3) {
                case 1 :
                    // InternalRuleDsl.g:2882:24: 'COUNT'
                    {
                    match("COUNT"); 
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2884:13: ( RULE_INT '.' RULE_INT )
            // InternalRuleDsl.g:2884:15: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mRULE_SETOPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2886:18: ( ( 'UNION' | 'EXCEPT' | 'INTERSECT' ) )
            // InternalRuleDsl.g:2886:20: ( 'UNION' | 'EXCEPT' | 'INTERSECT' )
            {
            // InternalRuleDsl.g:2886:20: ( 'UNION' | 'EXCEPT' | 'INTERSECT' )
            int alt4=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt4) {
                case 1 :
                    // InternalRuleDsl.g:2886:21: 'UNION'
                    {
                    match("UNION"); 
                    ...
                    break;
                case 2 :
                    // InternalRuleDsl.g:2886:29: 'EXCEPT'
                    {
                    match("EXCEPT"); 
                    ...
                    break;
                case 3 :
                    // InternalRuleDsl.g:2886:38: 'INTERSECT'
                    {
                    match("INTERSECT"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2888:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRuleDsl.g:2888:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRuleDsl.g:2888:11: ( '^' )?
            int alt5=2;
            ...
            // InternalRuleDsl.g:2888:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2890:10: ( ( '0' .. '9' )+ )
            // InternalRuleDsl.g:2890:12: ( '0' .. '9' )+
            {
            // InternalRuleDsl.g:2890:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2892:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRuleDsl.g:2892:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRuleDsl.g:2892:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalRuleDsl.g:2892:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRuleDsl.g:2892:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalRuleDsl.g:2892:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRuleDsl.g:2892:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2894:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRuleDsl.g:2894:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRuleDsl.g:2894:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2896:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRuleDsl.g:2896:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRuleDsl.g:2896:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:2898:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRuleDsl.g:2898:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRuleDsl.g:2898:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g