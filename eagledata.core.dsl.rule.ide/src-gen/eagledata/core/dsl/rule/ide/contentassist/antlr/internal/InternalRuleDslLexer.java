...
public class InternalRuleDslLexer extends Lexer {
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:20:7: ( 'select' )
            // InternalRuleDsl.g:20:9: 'select'
            {
            match("select"); 
    ...
    public final void mT__27() throws RecognitionException {
        try {
            int _type = T__27;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:21:7: ( 'from' )
            // InternalRuleDsl.g:21:9: 'from'
            {
            match("from"); 
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:23:7: ( 'where' )
            // InternalRuleDsl.g:23:9: 'where'
            {
            match("where"); 
    ...
    public final void mT__30() throws RecognitionException {
        try {
            int _type = T__30;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:24:7: ( 'AND' )
            // InternalRuleDsl.g:24:9: 'AND'
            {
            match("AND"); 
    ...
    public final void mT__33() throws RecognitionException {
        try {
            int _type = T__33;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:27:7: ( 'compose' )
            // InternalRuleDsl.g:27:9: 'compose'
            {
            match("compose"); 
    ...
    public final void mT__35() throws RecognitionException {
        try {
            int _type = T__35;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:29:7: ( 'to' )
            // InternalRuleDsl.g:29:9: 'to'
            {
            match("to"); 
    ...
    public final void mRULE_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4149:15: ( ( '+' | '-' | '*' | 'DIV' ) )
            // InternalRuleDsl.g:4149:17: ( '+' | '-' | '*' | 'DIV' )
            {
            // InternalRuleDsl.g:4149:17: ( '+' | '-' | '*' | 'DIV' )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_LOGICALOPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4151:22: ( ( '>' | '<' | '>=' | '<=' | '=' ) )
            // InternalRuleDsl.g:4151:24: ( '>' | '<' | '>=' | '<=' | '=' )
            {
            // InternalRuleDsl.g:4151:24: ( '>' | '<' | '>=' | '<=' | '=' )
            int alt2=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_CONDITIONALOPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4153:26: ( ( 'AND' | 'OR' ) )
            // InternalRuleDsl.g:4153:28: ( 'AND' | 'OR' )
            {
            // InternalRuleDsl.g:4153:28: ( 'AND' | 'OR' )
            int alt3=2;
    ...
    public final void mRULE_SELECTOPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4155:21: ( ( 'COUNT' | 'MIN' | 'MAX' ) )
            // InternalRuleDsl.g:4155:23: ( 'COUNT' | 'MIN' | 'MAX' )
            {
            // InternalRuleDsl.g:4155:23: ( 'COUNT' | 'MIN' | 'MAX' )
            int alt4=3;
            ...
            switch (alt4) {
                case 1 :
                    // InternalRuleDsl.g:4155:24: 'COUNT'
                    {
                    match("COUNT"); 
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4157:13: ( RULE_INT '.' RULE_INT )
            // InternalRuleDsl.g:4157:15: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mRULE_SETOPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4159:18: ( ( 'UNION' | 'EXCEPT' | 'INTERSECT' ) )
            // InternalRuleDsl.g:4159:20: ( 'UNION' | 'EXCEPT' | 'INTERSECT' )
            {
            // InternalRuleDsl.g:4159:20: ( 'UNION' | 'EXCEPT' | 'INTERSECT' )
            int alt5=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt5) {
                case 1 :
                    // InternalRuleDsl.g:4159:21: 'UNION'
                    {
                    match("UNION"); 
                    ...
                    break;
                case 2 :
                    // InternalRuleDsl.g:4159:29: 'EXCEPT'
                    {
                    match("EXCEPT"); 
                    ...
                    break;
                case 3 :
                    // InternalRuleDsl.g:4159:38: 'INTERSECT'
                    {
                    match("INTERSECT"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4161:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRuleDsl.g:4161:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRuleDsl.g:4161:11: ( '^' )?
            int alt6=2;
            ...
            // InternalRuleDsl.g:4161:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalRuleDsl.g:4163:19: ( ( '0' .. '9' )+ )
            // InternalRuleDsl.g:4163:21: ( '0' .. '9' )+
            {
            // InternalRuleDsl.g:4163:21: ( '0' .. '9' )+
            int cnt8=0;
            loop8:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4165:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRuleDsl.g:4165:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRuleDsl.g:4165:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalRuleDsl.g:4165:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRuleDsl.g:4165:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                    ...
                    break;
                case 2 :
                    // InternalRuleDsl.g:4165:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRuleDsl.g:4165:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4167:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRuleDsl.g:4167:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRuleDsl.g:4167:24: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4169:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRuleDsl.g:4169:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRuleDsl.g:4169:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4171:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRuleDsl.g:4171:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRuleDsl.g:4171:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuleDsl.g:4173:16: ( . )
            // InternalRuleDsl.g:4173:18: .
            {
            matchAny(); 
    ...
    static final String DFA17_eotS =
        "\1\uffff\1\50\1\52\1\uffff\2\50\2\uffff\3\50\1\uffff\2\50\2\uffff\1\50\4\uffff\1\50\3\uffff\3\50\1\46\3\50\1\46\1\uffff\3\46\2\uffff\1\50\4\uffff\1\115\1\116\2\uffff\1\50\1\120\2\50\1\uffff\2\50\2\uffff\1\50\4\uffff\1\50\1\uffff\1\127\3\50\1\uffff\3\50\4\uffff\1\50\2\uffff\1\50\1\uffff\3\50\1\143\1\50\1\75\1\uffff\1\50\2\146\4\50\1\153\1\50\1\155\1\50\1\uffff\2\50\1\uffff\4\50\1\uffff\1\50\1\uffff\1\166\1\50\1\146\1\170\2\50\1\173\1\174\1\uffff\1\50\1\uffff\1\170\1\50\2\uffff\1\177\1\50\1\uffff\1\50\1\170";
    static final String DFA17_eofS =
        "\u0082\uffff";
    static final String DFA17_minS =
        "\1\0\1\155\1\52\1\uffff\1\156\1\157\2\uffff\1\150\1\145\1\162\1\uffff\1\150\1\116\2\uffff\1\157\4\uffff\1\111\3\uffff\1\122\1\117\1\101\1\56\1\116\1\130\1\116\1\101\1\uffff\2\0\1\52\2\uffff\1\160\4\uffff\2\60\2\uffff\1\145\1\60\1\154\1\157\1\uffff\1\145\1\104\2\uffff\1\155\4\uffff\1\126\1\uffff\1\60\1\125\1\116\1\130\1\uffff\1\111\1\103\1\124\4\uffff\1\157\2\uffff\1\156\1\uffff\1\145\1\155\1\162\1\60\1\160\1\60\1\uffff\1\116\2\60\1\117\2\105\1\162\1\60\1\143\1\60\1\145\1\uffff\1\157\1\124\1\uffff\1\116\1\120\1\122\1\164\1\uffff\1\164\1\uffff\1\60\1\163\2\60\1\124\1\123\2\60\1\uffff\1\145\1\uffff\1\60\1\105\2\uffff\1\60\1\103\1\uffff\1\124\1\60";
