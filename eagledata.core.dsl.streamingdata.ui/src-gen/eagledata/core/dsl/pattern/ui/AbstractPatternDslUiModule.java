...
import eagledata.core.dsl.pattern.ide.contentassist.antlr.PartialPatternDslContentAssistParser;
...
import eagledata.core.dsl.pattern.ui.contentassist.PatternDslProposalProvider;
import eagledata.core.dsl.pattern.ui.labeling.PatternDslDescriptionLabelProvider;
import eagledata.core.dsl.pattern.ui.labeling.PatternDslLabelProvider;
import eagledata.core.dsl.pattern.ui.outline.PatternDslOutlineTreeProvider;
...
/**
 * Manual modifications go to {@link PatternDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractPatternDslUiModule extends DefaultXbaseUiModule {

	public AbstractPatternDslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(eagledata.core.dsl.pattern.parser.antlr.internal.InternalPatternDslLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalPatternDslLexer.class).toProvider(LexerProvider.create(InternalPatternDslLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return PatternDslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(PatternDslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return PatternDslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return PatternDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return PatternDslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialPatternDslContentAssistParser.class;
	}
