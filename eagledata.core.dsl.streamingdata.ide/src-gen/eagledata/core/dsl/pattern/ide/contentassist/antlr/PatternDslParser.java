		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getKeyOptionAccess().getAlternatives(), "rule__KeyOption__Alternatives");
					...
					put(grammarAccess.getPhraseAccess().getGroup_3(), "rule__Phrase__Group_3__0");
					put(grammarAccess.getPhraseAccess().getGroup_6(), "rule__Phrase__Group_6__0");
					put(grammarAccess.getPhraseAccess().getGroup_6_1(), "rule__Phrase__Group_6_1__0");
					...
					put(grammarAccess.getTermKeyAccess().getGroup(), "rule__TermKey__Group__0");
					put(grammarAccess.getOperationAccess().getGroup(), "rule__Operation__Group__0");
					put(grammarAccess.getOperationAccess().getGroup_3(), "rule__Operation__Group_3__0");
					put(grammarAccess.getOperationAccess().getGroup_3_2(), "rule__Operation__Group_3_2__0");
					put(grammarAccess.getStringOptionAccess().getGroup(), "rule__StringOption__Group__0");
					put(grammarAccess.getPathOptionAccess().getGroup(), "rule__PathOption__Group__0");
					put(grammarAccess.getPathOptionAccess().getGroup_1(), "rule__PathOption__Group_1__0");
					put(grammarAccess.getPathOptionAccess().getGroup_2(), "rule__PathOption__Group_2__0");
					put(grammarAccess.getPathOptionAccess().getGroup_2_4(), "rule__PathOption__Group_2_4__0");
					put(grammarAccess.getKeyOptionObjectAccess().getGroup(), "rule__KeyOptionObject__Group__0");
					put(grammarAccess.getKeyOptionAttrAccess().getGroup(), "rule__KeyOptionAttr__Group__0");
					put(grammarAccess.getKeyOptionArrayAccess().getGroup(), "rule__KeyOptionArray__Group__0");
					put(grammarAccess.getKeyOptionArrayAccess().getGroup_2(), "rule__KeyOptionArray__Group_2__0");
					put(grammarAccess.getKeyOptionArrayAccess().getGroup_2_1(), "rule__KeyOptionArray__Group_2_1__0");
					...
					put(grammarAccess.getStreamingModelAccess().getImportSectionAssignment_0(), "rule__StreamingModel__ImportSectionAssignment_0");
					put(grammarAccess.getStreamingModelAccess().getDescriptionsAssignment_1(), "rule__StreamingModel__DescriptionsAssignment_1");
					put(grammarAccess.getStreamingModelAccess().getDescriptionsAssignment_2(), "rule__StreamingModel__DescriptionsAssignment_2");
					...
					put(grammarAccess.getPhraseAccess().getConnectionAssignment_0(), "rule__Phrase__ConnectionAssignment_0");
					put(grammarAccess.getPhraseAccess().getNameAssignment_2(), "rule__Phrase__NameAssignment_2");
					put(grammarAccess.getPhraseAccess().getInAGeoAssignment_3_1(), "rule__Phrase__InAGeoAssignment_3_1");
					put(grammarAccess.getPhraseAccess().getOrderedAssignment_4(), "rule__Phrase__OrderedAssignment_4");
					put(grammarAccess.getPhraseAccess().getFeaturesAssignment_6_0(), "rule__Phrase__FeaturesAssignment_6_0");
					put(grammarAccess.getPhraseAccess().getFeaturesAssignment_6_1_1(), "rule__Phrase__FeaturesAssignment_6_1_1");
					...
					put(grammarAccess.getTermKeyAccess().getTypeAssignment_0(), "rule__TermKey__TypeAssignment_0");
					put(grammarAccess.getTermKeyAccess().getNameAssignment_1(), "rule__TermKey__NameAssignment_1");
					...
					put(grammarAccess.getOperationAccess().getParametersAssignment_3_1(), "rule__Operation__ParametersAssignment_3_1");
					put(grammarAccess.getOperationAccess().getParametersAssignment_3_2_1(), "rule__Operation__ParametersAssignment_3_2_1");
					...
					put(grammarAccess.getPathOptionAccess().getKeyAssignment_0(), "rule__PathOption__KeyAssignment_0");
					put(grammarAccess.getPathOptionAccess().getKeyAssignment_1_1(), "rule__PathOption__KeyAssignment_1_1");
					put(grammarAccess.getPathOptionAccess().getPropertyAssignment_2_1(), "rule__PathOption__PropertyAssignment_2_1");
					put(grammarAccess.getPathOptionAccess().getValuesAssignment_2_3(), "rule__PathOption__ValuesAssignment_2_3");
					put(grammarAccess.getPathOptionAccess().getValuesAssignment_2_4_1(), "rule__PathOption__ValuesAssignment_2_4_1");
					put(grammarAccess.getKeyOptionObjectAccess().getKeyAssignment_1(), "rule__KeyOptionObject__KeyAssignment_1");
					put(grammarAccess.getKeyOptionAttrAccess().getKeyAssignment_1(), "rule__KeyOptionAttr__KeyAssignment_1");
					put(grammarAccess.getKeyOptionArrayAccess().getKeyAssignment_0(), "rule__KeyOptionArray__KeyAssignment_0");
					put(grammarAccess.getKeyOptionArrayAccess().getMinElementAssignment_2_0(), "rule__KeyOptionArray__MinElementAssignment_2_0");
					put(grammarAccess.getKeyOptionArrayAccess().getMaxElementAssignment_2_1_1(), "rule__KeyOptionArray__MaxElementAssignment_2_1_1");
