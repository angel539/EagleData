		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPhraseAccess().getGroup_5(), "rule__Phrase__Group_5__0");
					put(grammarAccess.getPhraseAccess().getGroup_7(), "rule__Phrase__Group_7__0");
					put(grammarAccess.getPhraseAccess().getGroup_7_2(), "rule__Phrase__Group_7_2__0");
					...
					put(grammarAccess.getPhraseAccess().getConceptsAssignment_4(), "rule__Phrase__ConceptsAssignment_4");
					put(grammarAccess.getPhraseAccess().getConceptsAssignment_5_1(), "rule__Phrase__ConceptsAssignment_5_1");
					put(grammarAccess.getPhraseAccess().getOptionsAssignment_7_1(), "rule__Phrase__OptionsAssignment_7_1");
					put(grammarAccess.getPhraseAccess().getOptionsAssignment_7_2_1(), "rule__Phrase__OptionsAssignment_7_2_1");
