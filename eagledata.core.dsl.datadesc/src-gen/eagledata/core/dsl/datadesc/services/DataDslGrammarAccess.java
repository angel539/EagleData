...
public class DataDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class AbstractDescriptionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cFeedParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		
		//AbstractDescription data::AbstractDescription:
		//	DataDescription | Fragment | Feed
		@Override public ParserRule getRule() { return rule; }
		...
		//Feed
		public RuleCall getFeedParserRuleCall_2() { return cFeedParserRuleCall_2; }
	}
	...
	public class CompositeNodeElements extends AbstractParserRuleElementFinder {
		...
		/// *JvmNode returns data::JvmNode:
		//	(key?="key" | unique?="unique")?
		//	type=JvmTypeReference name=ID ('['cardinality=Cardinality']')?	('(' options += Option ( "," options+=Option)* ')')?
	...
	public class DataDescriptionElements extends AbstractParserRuleElementFinder {
		...
		//'description' format=STRING name=ID (':' fragments+=[data::Fragment|QualifiedName] (','
		//fragments+=[data::Fragment|QualifiedName])*)? '{' (nodes+=Node nodes+=Node*)? '}' ('(' options+=Option (","
		//options+=Option)* ')')?
		public Group getGroup() { return cGroup; }
	...
	public class FeedElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eagledata.core.dsl.datadesc.DataDsl.Feed");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cFeedKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		private final Keyword cColonKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cDescriptionAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final CrossReference cDescriptionDataDescriptionCrossReference_3_0 = (CrossReference)cDescriptionAssignment_3.eContents().get(0);
		private final RuleCall cDescriptionDataDescriptionQualifiedNameParserRuleCall_3_0_1 = (RuleCall)cDescriptionDataDescriptionCrossReference_3_0.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cPathsAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cPathsSTRINGTerminalRuleCall_5_0 = (RuleCall)cPathsAssignment_5.eContents().get(0);
		private final Assignment cPathsAssignment_6 = (Assignment)cGroup.eContents().get(6);
		private final RuleCall cPathsSTRINGTerminalRuleCall_6_0 = (RuleCall)cPathsAssignment_6.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_7 = (Keyword)cGroup.eContents().get(7);
		
		//Feed data::Feed:
		//	'feed' name=ID ':' description=[data::DataDescription|QualifiedName] '{'
		//	paths+=STRING paths+=STRING*
		//	'}'
		@Override public ParserRule getRule() { return rule; }
		
		//'feed' name=ID ':' description=[data::DataDescription|QualifiedName] '{' paths+=STRING paths+=STRING* '}'
		public Group getGroup() { return cGroup; }
		
		//'feed'
		public Keyword getFeedKeyword_0() { return cFeedKeyword_0; }
		...
		//description=[data::DataDescription|QualifiedName]
		public Assignment getDescriptionAssignment_3() { return cDescriptionAssignment_3; }
		
		//[data::DataDescription|QualifiedName]
		public CrossReference getDescriptionDataDescriptionCrossReference_3_0() { return cDescriptionDataDescriptionCrossReference_3_0; }
		
		//QualifiedName
		public RuleCall getDescriptionDataDescriptionQualifiedNameParserRuleCall_3_0_1() { return cDescriptionDataDescriptionQualifiedNameParserRuleCall_3_0_1; }
		...
		//STRING
		public RuleCall getPathsSTRINGTerminalRuleCall_5_0() { return cPathsSTRINGTerminalRuleCall_5_0; }
		
		//paths+=STRING*
		public Assignment getPathsAssignment_6() { return cPathsAssignment_6; }
		
		//STRING
		public RuleCall getPathsSTRINGTerminalRuleCall_6_0() { return cPathsSTRINGTerminalRuleCall_6_0; }
	...
	private final FeedElements pFeed;
	...
	//	paths+=STRING paths+=STRING*
	//	'}'
	public FeedElements getFeedAccess() {
		return pFeed;
	}
	
	public ParserRule getFeedRule() {
		return getFeedAccess().getRule();
	}
