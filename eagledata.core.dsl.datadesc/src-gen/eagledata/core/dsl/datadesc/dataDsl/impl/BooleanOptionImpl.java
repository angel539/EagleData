 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadesc.dataDsl.impl.BooleanOptionImpl#getKey <em>Key</em>}</li>
 *   <li>{@link eagledata.core.dsl.datadesc.dataDsl.impl.BooleanOptionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanOptionImpl extends OptionImpl implements BooleanOption
{
   ...
   * @ordered
   */
  protected static final BooleanOptionKey KEY_EDEFAULT = BooleanOptionKey.NULLABLE;
  ...
  {
    return DataDslPackage.Literals.BOOLEAN_OPTION;
  }
  ...
  public void setKey(BooleanOptionKey newKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDslPackage.BOOLEAN_OPTION__KEY, oldKey, key));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDslPackage.BOOLEAN_OPTION__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DataDslPackage.BOOLEAN_OPTION__KEY:
        return getKey();
      case DataDslPackage.BOOLEAN_OPTION__VALUE:
        return getValue();
    }
