 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadesc.dataDsl.impl.IntOptionImpl#getKey <em>Key</em>}</li>
 *   <li>{@link eagledata.core.dsl.datadesc.dataDsl.impl.IntOptionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntOptionImpl extends OptionImpl implements IntOption
{
   ...
   * @ordered
   */
  protected static final IntOptionKey KEY_EDEFAULT = IntOptionKey.MIN_LENGTH;
  ...
  {
    return DataDslPackage.Literals.INT_OPTION;
  }
  ...
  public void setKey(IntOptionKey newKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDslPackage.INT_OPTION__KEY, oldKey, key));
  }
  ...
  public void setValue(int newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDslPackage.INT_OPTION__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DataDslPackage.INT_OPTION__KEY:
        return getKey();
      case DataDslPackage.INT_OPTION__VALUE:
        return getValue();
    }
