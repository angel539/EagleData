...
public class DataDslPackageImpl extends EPackageImpl implements DataDslPackage
{
   ...
   * @generated
   */
  private EClass feedEClass = null;
   ...
   * @generated
   */
  public EReference getDataDescription_Fragments()
  {
  ...
  {
    return (EReference)dataDescriptionEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getFragment_Fragments()
  {
   ...
   * @generated
   */
  public EReference getFragment_Nodes()
  {
   ...
   * @generated
   */
  public EReference getFeed_Description()
  {
    return (EReference)feedEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getFeed_Paths()
  {
    return (EAttribute)feedEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(dataDescriptionEClass, DATA_DESCRIPTION__FRAGMENTS);
    ...
    createEReference(fragmentEClass, FRAGMENT__FRAGMENTS);
    createEReference(fragmentEClass, FRAGMENT__NODES);

    feedEClass = createEClass(FEED);
    createEReference(feedEClass, FEED__DESCRIPTION);
    createEAttribute(feedEClass, FEED__PATHS);
  ...
  public void initializePackageContents()
  {
    ...
    feedEClass.getESuperTypes().add(this.getAbstractDescription());
    ...
    initEAttribute(getCardinality_Min(), ecorePackage.getEString(), "min", null, 0, 1, Cardinality.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDataDescription_Fragments(), this.getFragment(), null, "fragments", null, 0, -1, DataDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getFragment_Fragments(), this.getFragment(), null, "fragments", null, 0, -1, Fragment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFragment_Nodes(), this.getNode(), null, "nodes", null, 0, -1, Fragment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(feedEClass, Feed.class, "Feed", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFeed_Description(), this.getDataDescription(), null, "description", null, 0, 1, Feed.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getFeed_Paths(), ecorePackage.getEString(), "paths", null, 0, -1, Feed.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
