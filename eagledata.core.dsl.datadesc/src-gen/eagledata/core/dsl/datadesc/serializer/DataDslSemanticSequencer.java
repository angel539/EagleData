...
public class DataDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DataDslPackage.eINSTANCE)
			...
			case DataDslPackage.FEED:
				sequence_Feed(context, (Feed) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     DataModelElement returns Feed
	 *     SpecificationElement returns Feed
	 *     AbstractDescription returns Feed
	 *     Feed returns Feed
	 *
	 * Constraint:
	 *     (name=ID description=[DataDescription|QualifiedName] paths+=STRING paths+=STRING*)
	 */
	protected void sequence_Feed(ISerializationContext context, Feed semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
