...
/**
 * This is the item provider adapter for a {@link ecarules.Point} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointItemProvider extends GeographicalElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_lat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_lat_feature", "_UI_Point_type"),
				 EcarulesPackage.Literals.POINT__LAT,
				 true,
				 false,
				 false,
	...
	protected void addLongPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_long_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_long_feature", "_UI_Point_type"),
				 EcarulesPackage.Literals.POINT__LONG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Point.class)) {
			case EcarulesPackage.POINT__LAT:
			case EcarulesPackage.POINT__LONG:
