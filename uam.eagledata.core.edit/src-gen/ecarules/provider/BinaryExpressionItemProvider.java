...
/**
 * This is the item provider adapter for a {@link ecarules.BinaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryExpressionItemProvider extends ConditionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryExpression_left_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryExpression_left_feature", "_UI_BinaryExpression_type"),
				 EcarulesPackage.Literals.BINARY_EXPRESSION__LEFT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryExpression_right_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryExpression_right_feature", "_UI_BinaryExpression_type"),
				 EcarulesPackage.Literals.BINARY_EXPRESSION__RIGHT,
				 true,
				 false,
				 true,
				 null,
