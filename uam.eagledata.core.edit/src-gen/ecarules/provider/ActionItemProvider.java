...
public class ActionItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcarulesPackage.Literals.ACTION__ACTION_PARAMS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Action.class)) {
			case EcarulesPackage.ACTION__ACTION_PARAMS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcarulesPackage.Literals.ACTION__ACTION_PARAMS,
				 EcarulesFactory.eINSTANCE.createConceptParam()));

		newChildDescriptors.add
			(createChildParameter
				(EcarulesPackage.Literals.ACTION__ACTION_PARAMS,
				 EcarulesFactory.eINSTANCE.createStringParam()));
	}
