...
/**
 * This is the item provider adapter for a {@link ecarules.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcarulesPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_descriptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_descriptions_feature", "_UI_NamedElement_type"),
				 EcarulesPackage.Literals.NAMED_ELEMENT__DESCRIPTIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcarulesPackage.Literals.NAMED_ELEMENT__DESCRIPTOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_value_feature", "_UI_NamedElement_type"),
				 EcarulesPackage.Literals.NAMED_ELEMENT__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedElement.class)) {
			case EcarulesPackage.NAMED_ELEMENT__NAME:
			case EcarulesPackage.NAMED_ELEMENT__VALUE:
