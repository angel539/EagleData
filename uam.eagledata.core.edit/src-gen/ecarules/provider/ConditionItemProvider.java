...
/**
 * This is the item provider adapter for a {@link ecarules.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_geo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_geo_feature", "_UI_Condition_type"),
				 EcarulesPackage.Literals.CONDITION__GEO,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcarulesPackage.Literals.CONDITION__EXPRESSION);
			childrenFeatures.add(EcarulesPackage.Literals.CONDITION__TRIGGERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Condition.class)) {
			case EcarulesPackage.CONDITION__EXPRESSION:
			case EcarulesPackage.CONDITION__TRIGGERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcarulesPackage.Literals.CONDITION__EXPRESSION,
				 EcarulesFactory.eINSTANCE.createExpression()));
