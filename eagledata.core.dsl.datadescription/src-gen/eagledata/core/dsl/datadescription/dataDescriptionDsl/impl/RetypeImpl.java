 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.RetypeImpl#getNewType <em>New Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RetypeImpl extends NodeDeprecationImpl implements Retype
{
  ...
  {
    return DataDescriptionDslPackage.Literals.RETYPE;
  }
  ...
  public NotificationChain basicSetNewType(TypeSpecification newNewType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataDescriptionDslPackage.RETYPE__NEW_TYPE, oldNewType, newNewType);
  ...
  public void setNewType(TypeSpecification newNewType)
  {
    if (newNewType != newType)
    {
      ...
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataDescriptionDslPackage.RETYPE__NEW_TYPE, null, msgs);
      if (newNewType != null)
        msgs = ((InternalEObject)newNewType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataDescriptionDslPackage.RETYPE__NEW_TYPE, null, msgs);
      msgs = basicSetNewType(newNewType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDescriptionDslPackage.RETYPE__NEW_TYPE, newNewType, newNewType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DataDescriptionDslPackage.RETYPE__NEW_TYPE:
