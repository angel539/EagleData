 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.NodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.NodeImpl#getRepresentedAs <em>Represented As</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeImpl extends MinimalEObjectImpl.Container implements Node
{
  ...
  {
    return DataDescriptionDslPackage.Literals.NODE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDescriptionDslPackage.NODE__NAME, oldName, name));
  }
  ...
  public void setRepresentedAs(String newRepresentedAs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDescriptionDslPackage.NODE__REPRESENTED_AS, oldRepresentedAs, representedAs));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DataDescriptionDslPackage.NODE__NAME:
        return getName();
      case DataDescriptionDslPackage.NODE__REPRESENTED_AS:
