 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.DataModelImpl#getImportURI <em>Import URI</em>}</li>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.DataModelImpl#getDescriptions <em>Descriptions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataModelImpl extends MinimalEObjectImpl.Container implements DataModel
{
  ...
  {
    return DataDescriptionDslPackage.Literals.DATA_MODEL;
  }
  ...
  public EList<String> getImportURI()
  {
    if (importURI == null)
    {
      importURI = new EDataTypeEList<String>(String.class, this, DataDescriptionDslPackage.DATA_MODEL__IMPORT_URI);
    }
    return importURI;
  }
  ...
  public EList<DataDescription> getDescriptions()
  {
    ...
    {
      descriptions = new EObjectContainmentEList<DataDescription>(DataDescription.class, this, DataDescriptionDslPackage.DATA_MODEL__DESCRIPTIONS);
    }
    return descriptions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DataDescriptionDslPackage.DATA_MODEL__DESCRIPTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DataDescriptionDslPackage.DATA_MODEL__IMPORT_URI:
        return getImportURI();
      case DataDescriptionDslPackage.DATA_MODEL__DESCRIPTIONS:
