 ...
 * </p>
 * <ul>
 *   <li>{@link resourceset.impl.TableColumnImpl#getColumns <em>Columns</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableColumnImpl extends ColumnImpl implements TableColumn {
	...
	protected EClass eStaticClass() {
		return ResourcesetPackage.Literals.TABLE_COLUMN;
	}
	...
	public EList<Column> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentEList<Column>(Column.class, this, ResourcesetPackage.TABLE_COLUMN__COLUMNS);
		}
		return columns;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResourcesetPackage.TABLE_COLUMN__COLUMNS:
