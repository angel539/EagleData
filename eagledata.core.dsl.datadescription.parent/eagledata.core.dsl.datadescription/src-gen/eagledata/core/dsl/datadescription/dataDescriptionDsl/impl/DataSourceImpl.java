 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.DataSourceImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.DataSourceImpl#getLink <em>Link</em>}</li>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.DataSourceImpl#getFragments <em>Fragments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataSourceImpl extends DataDescriptionImpl implements DataSource
{
  ...
  {
    return DataDescriptionDslPackage.Literals.DATA_SOURCE;
  }
  ...
  public NotificationChain basicSetFormat(FormatSpecification newFormat, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataDescriptionDslPackage.DATA_SOURCE__FORMAT, oldFormat, newFormat);
  ...
  public void setFormat(FormatSpecification newFormat)
  {
    if (newFormat != format)
    {
      ...
      if (format != null)
        msgs = ((InternalEObject)format).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataDescriptionDslPackage.DATA_SOURCE__FORMAT, null, msgs);
      if (newFormat != null)
        msgs = ((InternalEObject)newFormat).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataDescriptionDslPackage.DATA_SOURCE__FORMAT, null, msgs);
      msgs = basicSetFormat(newFormat, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDescriptionDslPackage.DATA_SOURCE__FORMAT, newFormat, newFormat));
  }
  ...
  public EList<String> getLink()
  {
    if (link == null)
    {
      link = new EDataTypeEList<String>(String.class, this, DataDescriptionDslPackage.DATA_SOURCE__LINK);
    }
    return link;
  }
  ...
  public EList<DataFragment> getFragments()
  {
    if (fragments == null)
    {
      fragments = new EObjectResolvingEList<DataFragment>(DataFragment.class, this, DataDescriptionDslPackage.DATA_SOURCE__FRAGMENTS);
    }
    return fragments;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DataDescriptionDslPackage.DATA_SOURCE__FORMAT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DataDescriptionDslPackage.DATA_SOURCE__FORMAT:
        return getFormat();
      case DataDescriptionDslPackage.DATA_SOURCE__LINK:
        return getLink();
      case DataDescriptionDslPackage.DATA_SOURCE__FRAGMENTS:
        return getFragments();
    }
