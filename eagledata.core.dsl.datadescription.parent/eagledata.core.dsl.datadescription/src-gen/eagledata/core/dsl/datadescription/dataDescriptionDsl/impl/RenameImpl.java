 ...
 * </p>
 * <ul>
 *   <li>{@link eagledata.core.dsl.datadescription.dataDescriptionDsl.impl.RenameImpl#getNewRepresentedAs <em>New Represented As</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RenameImpl extends NodeDeprecationImpl implements Rename
{
  ...
  {
    return DataDescriptionDslPackage.Literals.RENAME;
  }
  ...
  public void setNewRepresentedAs(String newNewRepresentedAs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataDescriptionDslPackage.RENAME__NEW_REPRESENTED_AS, oldNewRepresentedAs, newRepresentedAs));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DataDescriptionDslPackage.RENAME__NEW_REPRESENTED_AS:
