		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSemanticNodeAccess().getGroup_4(), "rule__SemanticNode__Group_4__0");
					put(grammarAccess.getSemanticNodeAccess().getGroup_4_2(), "rule__SemanticNode__Group_4_2__0");
					...
					put(grammarAccess.getPrimitiveTypeDataPropertyAccess().getGroup_5(), "rule__PrimitiveTypeDataProperty__Group_5__0");
					put(grammarAccess.getPrimitiveTypeDataPropertyAccess().getGroup_5_2(), "rule__PrimitiveTypeDataProperty__Group_5_2__0");
					...
					put(grammarAccess.getEnumerationDataPropertyAccess().getGroup_5(), "rule__EnumerationDataProperty__Group_5__0");
					put(grammarAccess.getEnumerationDataPropertyAccess().getGroup_5_2(), "rule__EnumerationDataProperty__Group_5_2__0");
					...
					put(grammarAccess.getSemanticNodeAccess().getSupersAssignment_4_1(), "rule__SemanticNode__SupersAssignment_4_1");
					put(grammarAccess.getSemanticNodeAccess().getSupersAssignment_4_2_1(), "rule__SemanticNode__SupersAssignment_4_2_1");
					...
					put(grammarAccess.getSemanticNodeAccess().getMetaDataValueAssignment_8_1(), "rule__SemanticNode__MetaDataValueAssignment_8_1");
					put(grammarAccess.getSemanticNodeAccess().getMetaDataValueAssignment_8_2_1(), "rule__SemanticNode__MetaDataValueAssignment_8_2_1");
					...
					put(grammarAccess.getPrimitiveTypeDataPropertyAccess().getTypeAssignment_3(), "rule__PrimitiveTypeDataProperty__TypeAssignment_3");
					put(grammarAccess.getPrimitiveTypeDataPropertyAccess().getLowerBoundAssignment_4_1(), "rule__PrimitiveTypeDataProperty__LowerBoundAssignment_4_1");
					put(grammarAccess.getPrimitiveTypeDataPropertyAccess().getUpperBoundAssignment_4_3(), "rule__PrimitiveTypeDataProperty__UpperBoundAssignment_4_3");
					put(grammarAccess.getPrimitiveTypeDataPropertyAccess().getMetaDataValueAssignment_5_1(), "rule__PrimitiveTypeDataProperty__MetaDataValueAssignment_5_1");
					put(grammarAccess.getPrimitiveTypeDataPropertyAccess().getMetaDataValueAssignment_5_2_1(), "rule__PrimitiveTypeDataProperty__MetaDataValueAssignment_5_2_1");
					put(grammarAccess.getEnumerationDataPropertyAccess().getNameAssignment_1(), "rule__EnumerationDataProperty__NameAssignment_1");
					put(grammarAccess.getEnumerationDataPropertyAccess().getTypeAssignment_3(), "rule__EnumerationDataProperty__TypeAssignment_3");
					put(grammarAccess.getEnumerationDataPropertyAccess().getLowerBoundAssignment_4_1(), "rule__EnumerationDataProperty__LowerBoundAssignment_4_1");
					put(grammarAccess.getEnumerationDataPropertyAccess().getUpperBoundAssignment_4_3(), "rule__EnumerationDataProperty__UpperBoundAssignment_4_3");
					put(grammarAccess.getEnumerationDataPropertyAccess().getMetaDataValueAssignment_5_1(), "rule__EnumerationDataProperty__MetaDataValueAssignment_5_1");
					put(grammarAccess.getEnumerationDataPropertyAccess().getMetaDataValueAssignment_5_2_1(), "rule__EnumerationDataProperty__MetaDataValueAssignment_5_2_1");
