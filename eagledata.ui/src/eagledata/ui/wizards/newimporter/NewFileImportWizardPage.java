...
public class NewFileImportWizardPage extends WizardPage {
	private Text path;
	private Composite container;
	
	public NewFileImportWizardPage(String pageName, String pageDescription) {
		super(pageName);
		setTitle(pageName);
		setDescription(pageDescription);
		setImageDescriptor(Activator.getImageDescriptor("icons/Folder-50.png"));
	}
