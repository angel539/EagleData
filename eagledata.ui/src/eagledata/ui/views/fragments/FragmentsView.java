...
public class FragmentsView extends ViewPart implements ITabbedPropertySheetPageContributor{
	...
	public void createPartControl(Composite parent) {
		...
		//FragmentsViewViewerComparator comparator = new FragmentsViewViewerComparator();
